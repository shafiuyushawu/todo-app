...
A simple to-do app for add your items to list of to-dos and be able to check when task is copleted
...
Command : 
```bash
git clone https://github.com/shafiuyushawu/todo-app.git
```
...
-  Stortind data using local storage
...
Feel free to check the [issues page](https://github.com/shafiuyushawu/todo-app/issues/).
...
I will like to give appreciation to myself for keeping up the dedication to this level in Microverse.
